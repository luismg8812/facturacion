...
public class DocumentoDaoImpl implements DocumentoDao{
	...
	public List<Documento> getByTipo(Long tipoDocumentoId,Date hoy,Date hoyFin,Long usuarioId) throws FactException {
		...
		try {
			String sql = "select d from Documento d where d.tipoDocumentoId.tipoDocumentoId =:tipoDocumentoId "
					...
					+ " and d.usuarioId.usuarioId =:usuarioId order by d.documentoId asc";
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Documento> getByHoyNoImpresas(List<Long> tipoDocumentoId, Date hoy, Date hoyfin) throws FactException {
		Session session = HibernateUtil.getSessionFactory().openSession();
		List<Documento> documentoList = new ArrayList<>(); 
		try {
			String sql = "select d from Documento d where d.tipoDocumentoId.tipoDocumentoId  in :tipoDocumentoId "
	...
	//SELECT BLOG_ITEM_SEQ.nextval FROM DUAL
		...
		public List<InfoDiario> buscarInfodiarioByFecha(Date fechaInicio, Date fechafin) throws FactException {
			...
			try {
				String sql = "select d from InfoDiario d where d.fechaInforme >= :hoy AND d.fechaInforme <= :hoyFin "; //tipo documento igual a factura de venta					
		...
		@SuppressWarnings("unchecked")
		@Override
		public List<Documento> getByTipoPago(List<Long> tipoPago, Date hoy, Date hoyFin, Long usuarioId,
